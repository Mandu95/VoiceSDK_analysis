...
def extract_by_colum(df, column_name, page_label):
    ...
    if page_label == "VoiceENR" or page_label == "VoiceMARK" or page_label == "VoiceDOC":
...
def main(page_label):
    ...
    # Notion 데이터 프레임 - tab 메뉴 값*대분류) 정제 한 데이터 프레임
    notion_df = filter_data_contains(notion_df, page_label)
